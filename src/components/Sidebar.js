          ...
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <CollapsableNavItem title="Dashboard" icon={faTable}>
                ...
                <NavItem title="All Traffic" link={Routes.DashboardOverview.path} icon={faChartPie} />
                <NavItem title="Product Analysis" link={Routes.DashboardOverview.path} icon={faChartPie} />
              ...
              {/* <NavItem title="Task List" icon={faList} link={Routes.Transactions.path} />
